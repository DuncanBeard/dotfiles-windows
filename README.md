# Duncan Beard's dotfiles for Windows
...
Are you a Mac user? Check out my [dotfiles](https://github.com/duncanbeard/dotfiles) repository.
...
From PowerShell:
```posh
git clone https://github.com/duncanbeard/dotfiles-windows.git; cd dotfiles-windows; . .\bootstrap.ps1
```
...
```bash
iex ((new-object net.webclient).DownloadString('https://raw.github.com/duncanbeard/dotfiles-windows/master/setup/install.ps1'))
```
...
Set-Environment "EMAIL" "Duncan Beard <duncan@duncanbeard.com>"
...
This repository is built around how I use Windows, which is predominantly in a VM hosted on macOS. As such, things like VNC, FileZilla, or Skype are not installed, as they are available to me on the macOS side, installed by my [OS X dotfiles](https://github.com/duncanbeard/dotfiles). If you are using Windows as your primary OS, you may want a different configuration that reflects that, and I recommend you [fork this repository](https://github.com/duncanbeard/dotfiles-windows/fork).
...
[welcome and encouraged](https://github.com/duncanbeard/dotfiles-windows/issues)!

## Author

| [![twitter/duncanbeard](http://gravatar.com/avatar/1318668b99b2d5a3900f3f7758763a69?s=70)](http://twitter.com/duncanbeard "Follow @duncanbeard on Twitter") |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Duncan Beard](http://twitter.com/duncanbeard/)                                                                                                               |
